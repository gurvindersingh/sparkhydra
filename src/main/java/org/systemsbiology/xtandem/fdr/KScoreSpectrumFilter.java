 ...
 * @date 8/26/13
 */
public class KScoreSpectrumFilter  implements  ISpectrumDataFilter {

    private  final double m_MinimumKScore;
    private  final double m_MaximumKScore;

    public KScoreSpectrumFilter(double minimumKScore ) {
        this(minimumKScore,Double.MAX_VALUE) ;
    }

    public KScoreSpectrumFilter(double minimumKScore, double maximumKScore) {
