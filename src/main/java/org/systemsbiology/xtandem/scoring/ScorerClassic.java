...
/**
 * org.systemsbiology.xtandem.scoring.ScorerClassic
 *  This is hydra scoring code preserved to show how things
 *  WERE done = new code is immutable and uses different arguments
 * @author Steve Lewis
 * @date Jan 11, 2011
 */
public class ScorerClassic implements Serializable  {
    public static ScorerClassic[] EMPTY_ARRAY = {};
    public static Class THIS_CLASS = ScorerClassic.class;
...
//    private Map<String, IScoredScan> m_ScansById = new HashMap<String, IScoredScan>();
    ...
    public ScorerClassic(IMainData params, SequenceUtilities su, SpectrumCondition sc,
