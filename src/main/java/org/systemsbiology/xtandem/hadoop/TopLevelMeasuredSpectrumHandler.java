 ...
 */
public class TopLevelMeasuredSpectrumHandler extends MeasuredSpectrumHandler implements ITopLevelSaxHandler {
    public TopLevelMeasuredSpectrumHandler() {
        super(null);
    }
    ...
    public void startElement(String uri, String localName, String el, Attributes attributes)
            throws SAXException
    {
        if(MeasuredSpectrumHandler.TAG.equals(el)) {
